...
static int example_run() {
    ...
    printf("KeyGen(mean): %u CPU cycles \n", (uint32_t)(mean_cpu[0]));
    ...
    printf("Total (mean): %u CPU cycles \n", (uint32_t)((mean_cpu[0]+mean_cpu[1]+mean_cpu[2])));
    #endif
